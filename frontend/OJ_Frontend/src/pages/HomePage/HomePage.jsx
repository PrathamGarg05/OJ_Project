  ...
  return (
    <div className="bg-gradient-to-b from-black via-gray-900 to-black text-white min-h-screen flex flex-col">
        ...
        <header className="py-20 px-6 text-center">
            ...
            <Link
                to="/problems"
                className="bg-purple-600 hover:bg-purple-700 px-8 py-3 rounded-full text-lg font-medium transition shadow-lg hover:shadow-purple-700/50"
                >
                Get Started
            </Link>
        </header>
        <section className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-3 gap-10">
            ...
            <div
                key={index}
                className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-xl p-6 shadow-xl hover:shadow-cyan-500/20 transition"
            >
