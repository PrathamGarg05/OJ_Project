...
function BoiletPlateButton() {
    ...
    return (
        <Button 
            className="px-4 py-2 text-sm bg-gray-100 dark:bg-gray-950 text-green-600 rounded-md shadow-lg hover:bg-gray-300 darkhover:bg-gray-900 disabled:cursor-not-allowed"
            disabled={loading}
